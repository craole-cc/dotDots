...
manage_env --set --var RUST_HOME --val "${DOTS_CFG:?}/rust"

#|->  Rustup
manage_env --set --var RUSTUP_HOME --val "${HOME:?}/.rustup"
case "${SYS_TYPE}" in
Windows) RUSTUP_CONFIG="${RUST_HOME}/rustup_win.toml" ;;
*) RUSTUP_CONFIG="${RUST_HOME}/rustup_unix.toml" ;;
esac
manage_env --set --var RUSTUP_CONFIG --val "${RUSTUP_CONFIG}"

#|->  Cargo
manage_env --set --var CARGO_HOME --val "${HOME}/.cargo"
manage_env --set --init --var CARGO_ENV --val "${RUST_HOME}/cargo.env"
manage_env --set --var CARGO_CONFIG --val "${RUST_HOME}/cargo.toml"
manage_env --set --var CARGO_CONFIG_USER --val "${CARGO_HOME}/config.toml"
...
#|->  Rustfmt
manage_env --set --var RUSTFMT_CONFIG --val "${RUST_HOME}/rustfmt.toml"
manage_env --set --var RUSTFMT_CONFIG_USER --val "${HOME}/.rustfmt.toml"
