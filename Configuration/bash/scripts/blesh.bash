...
## entry, the cursor is placed at the beginning (end) of the text.  When
...
## When the following setting is set to a non-empty value, ble.sh saves the TTY
## state at the end of the command execution and restores it before the next
...
## suggestion by auto-complete.  The default style is chosen just to make it
