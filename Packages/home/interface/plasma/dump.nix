{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "services/plasma-manager-commands.desktop".launch-foot-quake = [ ];
    ...
    configFile = {
      ...
      kdeglobals.General.AccentColor = "66,132,111";
      ...
      kdeglobals."KShortcutsDialog Settings"."Dialog Size" = "2307,633";
      ...
      kwinrc.NightColor.EveningBeginFixed = 1700;
      kwinrc.NightColor.LatitudeFixed = 18.015000;
      kwinrc.NightColor.LongitudeFixed = 77.490000;
      kwinrc.NightColor.Mode = "Times";
      kwinrc.NightColor.MorningBeginFixed = 0900;
      ...
      kwinrc."org.kde.kwin.shortcuts".footquake = "Meta+!";
      ...
      kwinrulesrc."2".Description = "Footake";
      kwinrulesrc."2".aboverule = 2;
      kwinrulesrc."2".acceptfocus = true;
      kwinrulesrc."2".acceptfocusrule = 2;
      kwinrulesrc."2".maximizeHorizontally = true;
      kwinrulesrc."2".maximizeHorizontallyrule = 3;
      kwinrulesrc."2".maximizeVertically = true;
      kwinrulesrc."2".maximizeVerticallyrule = 3;
      kwinrulesrc."2".maxsize = "786,1240";
      kwinrulesrc."2".maxsizerule = 2;
      kwinrulesrc."2".minsize = "786,1240";
      kwinrulesrc."2".minsizerule = 2;
      kwinrulesrc."2".noborder = true;
      kwinrulesrc."2".noborderrule = 2;
      kwinrulesrc."2".position = "2850,996";
      kwinrulesrc."2".positionrule = 2;
      kwinrulesrc."2".size = "786,1240";
      kwinrulesrc."2".sizerule = 2;
      kwinrulesrc."2".skipPager = true;
      kwinrulesrc."2".skipPagerrule = 3;
      kwinrulesrc."2".skipTaskbar = true;
      kwinrulesrc."2".skipTaskbarrule = 3;
      kwinrulesrc."2".skippagerrule = 2;
      kwinrulesrc."2".skipswitcher = true;
      kwinrulesrc."2".skipswitcherrule = 2;
      kwinrulesrc."2".skiptaskbar = true;
      kwinrulesrc."2".skiptaskbarrule = 2;
      kwinrulesrc."2".types = 1;
      kwinrulesrc."2".wmclass = "foot foot-quake";
      kwinrulesrc."2".wmclasscomplete = true;
      kwinrulesrc."2".wmclassmatch = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".Description = "Yakuake";
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".aboverule = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".desktopfile = "org.kde.yakuake";
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".desktopfilerule = 3;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".noborder = true;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".noborderrule = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".position = "1237,928";
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".positionrule = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".size = "2225,868";
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".sizerule = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".skippager = true;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".skippagerrule = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".skipswitcher = true;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".skipswitcherrule = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".skiptaskbarrule = 2;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".title = "~ : bash — Yakuake";
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".types = 1;
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".wmclass = "yakuake org.kde.yakuake";
      kwinrulesrc."38843984-ca30-4c81-a5eb-3c51f65f46aa".wmclassmatch = 1;
      kwinrulesrc.General.count = 3;
      kwinrulesrc.General.rules = "1,2,38843984-ca30-4c81-a5eb-3c51f65f46aa";
