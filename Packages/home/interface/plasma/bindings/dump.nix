{
  programs.plasma = {
    ...
    configFile = {
      ...
      kdeglobals.General.AccentColor = "70,160,154";
      ...
      kwinrc.Desktops.Id_2 = "96224d40-0f69-4e2a-846d-8482d176e88f";
      kwinrc.Desktops.Id_3 = "a256eb1f-77d0-4d17-85f4-915cb65f8e28";
      kwinrc.Desktops.Id_4 = "b5ba5182-1359-47c8-8237-8d6f94bb17e5";
