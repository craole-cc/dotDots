...
let
  ...
  /**
    ...
    ```
  */
  orDefault = { content, default }: if isEmpty content then default else content;
  ...
  /**
    ...
    ```
  */
  orNull = { content, default }: if content == null then default else content;
  ...
  */
  mapOrDefault =
    ...
    if isEmpty content then default else fn content;
  ...
  */
  mapOrNull =
    ...
    if content == null then default else fn content;
