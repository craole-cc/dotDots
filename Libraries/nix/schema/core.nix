...
let
  ...
  mkDevelopmentCapability =
    ...
    if explicit != null then
      explicit
    else if hardened then
      false
    else
      hostDeclared || userDeclared || true;
  ...
  mkCore =
    ...
    let
      ...
      defined = with derived; {
        ...
        id = if (host.id or null) != null then host.id else generateHexId { inherit name; };
        ...
        home =
          ...
          if src != null then
            ...
            throw "Host: '${name}' must explicitly set `paths.roots.repo` to the path of the repo.";
        ...
        system =
          ...
          if sys != null then
            ...
            throw "Host '${name}' must explicitly set 'system' or 'specs.platform'.";
