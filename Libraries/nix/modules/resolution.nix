{
  ...
  inherit (_.modules.generators.inputs.resolution) mkInputs;
  inherit (_.modules.generators.inputs.packages) mkPackages mkOverlays;
  inherit (_.modules.generators.inputs.modules) mkModules;
