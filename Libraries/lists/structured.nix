...
{_, ...}: let
  ...
  dev = import ./enums/development.nix {inherit _;};
  gui = import ./enums/gui.nix {inherit _;};
  hardware = import ./enums/hardware.nix {inherit _;};
  tui = import ./enums/tui.nix {inherit _;};
  user = import ./enums/user.nix {inherit _;};
in {
