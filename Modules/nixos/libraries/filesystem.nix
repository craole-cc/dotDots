    ...
    locateParentByChild = mkOption {
      ...
      default = child: workingDir: let
        ...
        in
          ...
          then dir # Found the file, return current directory
          else if dir == parentDir # Reached root
          then null
          else findUp parentDir; # Continue searching up
      in
        findUp workingDir;
    };
