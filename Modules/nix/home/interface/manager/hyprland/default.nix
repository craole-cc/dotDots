{
  ...
  payload = {
    ...
    # The currently running compositor may still have hyprland.conf open when a
    # rebuild activates this generation. Do not delete that file live: doing so
    # makes Hyprland reload into its autogenerated/emergency configuration.
    # Instead, UWSM selects the Lua entrypoint for the next session.
