  ...
  options.DOTS.Libraries.${mod} = with cfg; {
    ...
    locateParentByChild = mkOption {
      ...
      default = _child: let
        ...
        nullOrLocation =
          if result != null
          then builtins.toString result.path
          else null;
      in
        nullOrLocation;
    };
