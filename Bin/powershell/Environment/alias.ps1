#TODO: The default aliases do deem to be getting set
...
function Set-Defaults {
  ...
  if (-not (Get-Command Get-Editor -ErrorAction SilentlyContinue)) {
    ...
    $Script:defaultEditor = Get-AvailableEditor
  }
...
function Register-PathAliases {
  ...
  Write-Pretty -Tag 'Info' -ContextScope $script:ctxScope -OneLine `
    "Use 'Show-PathAliases' to see available aliases."
}
