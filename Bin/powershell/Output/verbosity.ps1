...
function Global:Get-VerbosityDefault {
  <#
    .SYNOPSIS
...
function Global:Get-VerbosityLevel {
  <#
    .SYNOPSIS
...
function Global:Get-VerbosityNumeric {
  <#
    .SYNOPSIS
...
function Global:Get-VerbosityColor {
  <#
    .SYNOPSIS
...
function Global:Get-VerbosityTag {
  <#
    .SYNOPSIS
...
function Global:Test-Verbosity {
  <#
    .SYNOPSIS
