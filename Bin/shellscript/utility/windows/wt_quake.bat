...
@REM wt --window _quake "C:\\Program Files\\Git\\bin\\bash.exe"
new-tab --profile "PowerShell"
new-tab --profile "Nushell"

@REM wt --window _quake "C:\\Program Files\\Git\\bin\\bash.exe"
wt --window _quake "C:\\Program Files\\PowerShell\\7-preview\\pwsh.exe"
new-tab "C:\\Users\\mrcra\\AppData\\Local\\Programs\\nu\\bin\\nu.exe"

@REM wt --window _quake "C:\\Program Files\\Git\\bin\\bash.exe" -NoLogo -WindowStyle Minimized
new-tab "C:\\Program Files\\Git\\bin\\bash.exe"
