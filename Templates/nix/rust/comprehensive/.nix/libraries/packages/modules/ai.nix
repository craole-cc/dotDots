    ...
    // optionalAttrs configuration.enable (with configuration; let
      ...
      packages = let
        common =
          ...
          // optionalAttrs includeClaude {
            claude-code = llm.claude-code or pkgs.claude-code-bin or pkgs.claude-code or null;
          }
          // optionalAttrs includeGemini {
            gemini-cli = llm.gemini-cli or pkgs.gemini-cli-bin or pkgs.gemini-cli or null;
          }
