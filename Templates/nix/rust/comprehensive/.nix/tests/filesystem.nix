...
in
{
  ...
  isIncludedDir = assertMsg (
    isIncludedDir "modules" "directory" && !(isIncludedDir "tmp" "directory") && !(isIncludedDir "foo.nix" "regular")
  ...
  collectFromDirNestedNoRecurse = assertMsg (
    (collectFromDir {
      path = nestedDir;
      recurse = false;
      ignore = [ ];
  ...
  collectFromDirNestedRecurse = assertMsg (
    (collectFromDir {
      path = nestedDir;
      recurse = true;
      ignore = [ ];
  ...
  collectFromDirIgnore = assertMsg (
    (collectFromDir {
      path = nestedDir;
      recurse = true;
      ignore = [
