...
let
  ...
  */
  recursiveAttrs = conditions: foldl recursiveUpdate { } (attrValues conditions);
  ...
  updateAttrs =
    ...
    recursiveUpdate default (optionalAttrs (lib.attrsets.hasAttr name value) (lib.attrsets.getAttr name value));
